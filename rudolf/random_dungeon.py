...
def random_dungeon(location,location_file):
    ...
    for i in range(data["dungeon_settings"]["steps"]):
        ...
        for dir in directions:
            ...
            if (y + directions[dir]["y"]) in range(data["dungeon_settings"]["height"]) and ( #not out of y coordinates
                x + directions[dir]["x"]) in range(data["dungeon_settings"]["width"]) and (  #not out of x coordinates
